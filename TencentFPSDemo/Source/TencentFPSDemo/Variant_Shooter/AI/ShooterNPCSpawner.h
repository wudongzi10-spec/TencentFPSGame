 ...
 */
UCLASS()
class TENCENTFPSDEMO_API AShooterNPCSpawner : public AActor
{
	GENERATED_BODY()
...
public:
	...
	/** Spawns one NPC immediately for GameMode-managed waves */
	AShooterNPC* SpawnNPCForWave();

protected:

	/** If true, this spawner keeps the original self-managed template respawn behavior */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category="NPC Spawner")
