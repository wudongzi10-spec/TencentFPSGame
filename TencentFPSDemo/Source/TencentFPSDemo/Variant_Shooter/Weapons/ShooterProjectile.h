 ...
 */
UCLASS(abstract)
class TENCENTFPSDEMO_API AShooterProjectile : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	/** Damage to apply on hit (Valorant-style body damage; head/leg multipliers applied by the target) */
	UPROPERTY(EditAnywhere, Category="Projectile|Hit", meta = (ClampMin = 0, ClampMax = 200))
